    ...
    <>
     <div className="grid max-w-screen-xl px-4 py-8 mx-auto mt-20 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto text-center place-self-center md:text-left lg:text-left lg:col-span-7">
          ...
          <h2 className="inline-block px-6 py-4 my-16 text-6xl font-bold bg-red-500 shadow-xl text-bold text-gray7">
          Introduccion 
          </h2>
            <p className='text-xl text-white'>Una startup de tecnología de punta, que se especializa en bots de redes sociales y bots de compras que utilizan las últimas tecnologías GPT.</p>
      ...
      <div className="mx-auto mt-20 text-center w-fit snap-proximity">
        ...
        <div className="mx-auto w-[60%] text-left hide">
